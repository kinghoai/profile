...
@endsection
@section('content')
    <form action="{{route('page.update', $page->id)}}" method="POST" enctype="multipart/form-data" style="width:100%">
        @csrf
        @method('PATCH')
        <div class="row">
            <div class="col-9">
                ...
                <div class="form-group">
                    <textarea class="form-control" name="content" style="height: 500px">{{$page->content}}</textarea>
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
